...
//std::string SHADER = "shaders/SeaScape.glsl";
//std::string SHADER = "shaders/Bezier.glsl";
//std::string SHADER = "shaders/Russia.glsl";
//std::string SHADER = "shaders/Flame.glsl";
//std::string SHADER = "shaders/Mike.glsl";
//std::string SHADER = "shaders/SmallPT.glsl";
...
int main(void)
{
    ...
    */
    ...
    std::string fragmentShader = parseShader(SHADER.c_str());
